...
public class ActivityNativeAdd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRequestSimpleAd = (CheckBox) findViewById(R.id.cb_simple);

        mRefresh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                refreshAd(mRequestAppInstallAds.isChecked(),
                        mRequestContentAds.isChecked(),mRequestSimpleAd.isChecked());
            }
        });
     ...
     * @param requestsimple
     */
    private void refreshAd(boolean requestAppInstallAds, boolean requestContentAds, boolean requestsimple) {
        if (!requestAppInstallAds && !requestContentAds && !requestsimple) {
            ...
            builder.forContentAd(new NativeContentAd.OnContentAdLoadedListener() {
                ...
                public void onContentAdLoaded(NativeContentAd ad) {
                    FrameLayout frameLayout =
                            (FrameLayout) findViewById(R.id.fl_adplaceholder);
                    NativeContentAdView adView = (NativeContentAdView) getLayoutInflater()
                            .inflate(R.layout.ad_simple, null);
                    populateSimpleAdd(ad, adView);
                    frameLayout.removeAllViews();
                    frameLayout.addView(adView);
                }
            });
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener() {
            ...
            public void onAdFailedToLoad(int errorCode) {
                Toast.makeText(ActivityNativeAdd.this, "Failed to load native ad: "
     ...
     * @param adView          the view to be populated
     */
    private void populateSimpleAdd(NativeContentAd ad, NativeContentAdView adView) {
        adView.setHeadlineView(adView.findViewById(R.id.mLblHeadline));
        adView.setImageView(adView.findViewById(R.id.imgImage));
